...
Webflow.require('ix').init([
  {"slug":"menu-button","name":"Menu Button","value":{"style":{},"triggers":[{"type":"click","selector":".menu-icon","descend":true,"stepsA":[{"display":"none"}],"stepsB":[{"display":"block"}]},{"type":"click","selector":".nav-menu","stepsA":[{"display":"block","opacity":1,"transition":"opacity 500ms ease 0ms"}],"stepsB":[{"opacity":0,"transition":"opacity 500ms ease 0ms"},{"display":"none"}]}]}}
]);
